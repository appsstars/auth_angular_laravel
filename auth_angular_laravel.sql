...
--
-- Base de datos: `auth_angular_laravel`
--
CREATE DATABASE IF NOT EXISTS `auth_angular_laravel` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `auth_angular_laravel`;
...
ALTER TABLE `type_user`
  ADD PRIMARY KEY (`id`),
  ADD KEY `type_user_id_user_foreign` (`id_user`),
  ADD KEY `type_user_id_rol_foreign` (`id_rol`);
...
--
-- Filtros para la tabla `type_user`
--
ALTER TABLE `type_user`
  ADD CONSTRAINT `type_user_id_rol_foreign` FOREIGN KEY (`id_rol`) REFERENCES `rol` (`id`),
  ADD CONSTRAINT `type_user_id_user_foreign` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`);
COMMIT;
